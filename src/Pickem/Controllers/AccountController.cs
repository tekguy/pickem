...
namespace Pickem.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public PickemUserManager<UserAccount> UserManager { get; private set; }
        ...
        public virtual async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                var user = await UserManager.FindAsync(model.UserAccount.EmailAddress, model.UserAccount.Password);
                if (user != null)
                {
